...
from natten_mlx.functional import na1d, na2d, na3d
...
def test_na3d_value_and_grad():
    q = mx.random.normal((1, 4, 5, 6, 2, 2))
    k = mx.random.normal((1, 4, 5, 6, 2, 2))
    v = mx.random.normal((1, 4, 5, 6, 2, 2))

    def loss_fn(v_in):
        out = na3d(q, k, v_in, kernel_size=(3, 3, 3))
        return mx.sum(out)
