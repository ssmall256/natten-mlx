...
nb::object na1d_qk_backward(
    ...
    try {
        return natten_mlx::nanobind_metal_runtime::na1d_qk_backward(
            q, k, grad_attn, kernel_size, stride, dilation, is_causal, scale);
...
nb::object na1d_av_backward(
    ...
    try {
        return natten_mlx::nanobind_metal_runtime::na1d_av_backward(
...
nb::object na2d_qk_backward(
    ...
    try {
        return natten_mlx::nanobind_metal_runtime::na2d_qk_backward(
            q, k, grad_attn, kernel_size, stride, dilation, is_causal, scale);
    } catch (const std::bad_cast&) {
        return natten_mlx::nanobind_backend::call_backend(
            "na2d_qk_backward", q, k, grad_attn, kernel_size, stride, dilation, is_causal, scale);
...
nb::object na2d_av_backward(
    ...
    try {
        return natten_mlx::nanobind_metal_runtime::na2d_av_backward(
            attn, v, grad_out, kernel_size, stride, dilation, is_causal);
    } catch (const std::bad_cast&) {
        return natten_mlx::nanobind_backend::call_backend(
            "na2d_av_backward", attn, v, grad_out, kernel_size, stride, dilation, is_causal);
...
nb::object na3d_qk_backward(
    ...
    try {
        return natten_mlx::nanobind_metal_runtime::na3d_qk_backward(
            q, k, grad_attn, kernel_size, stride, dilation, is_causal, scale);
    } catch (const std::bad_cast&) {
        return natten_mlx::nanobind_backend::call_backend(
            "na3d_qk_backward", q, k, grad_attn, kernel_size, stride, dilation, is_causal, scale);
...
nb::object na3d_av_backward(
    ...
    try {
        return natten_mlx::nanobind_metal_runtime::na3d_av_backward(
            attn, v, grad_out, kernel_size, stride, dilation, is_causal);
    } catch (const std::bad_cast&) {
        return natten_mlx::nanobind_backend::call_backend(
            "na3d_av_backward", attn, v, grad_out, kernel_size, stride, dilation, is_causal);
