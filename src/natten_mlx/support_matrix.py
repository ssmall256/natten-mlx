    ...
    return {
        ...
        "fast_metal": {
            ...
            "constraints": [
                ...
                "Split 2D fast path: square odd K, stride>=1 per axis, equal dilations, causal/non-causal per axis supported.",
                "Split 3D fast path: cubic odd K, stride>=1 per axis, equal dilations, causal/non-causal per axis supported.",
